...
| | |
|---|---|
| Last shipped build | **v0.60**, tagged `v0.60` — the spec round: the XP rate found, the dying-suite class closed, the bot's job loop rewritten, and the converter stack finally decomposed |
