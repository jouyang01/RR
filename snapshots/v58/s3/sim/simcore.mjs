    ...
    function snapshot() {
      ...
      return {
        ...
        targon: { shrine: count("shrine"), chapel: count("chapel"), sanctum: count("sanctum"),
                  ...
                  chapelVisible: buildingVisible(BUILDINGS.find(b2 => b2.id === "chapel")),
                  chapelCost: buildingCost(BUILDINGS.find(b2 => b2.id === "chapel")),
                  chapelAfford: canAfford(buildingCost(BUILDINGS.find(b2 => b2.id === "chapel"))),
